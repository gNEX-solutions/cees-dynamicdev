        ...
        foreach ($datas as $key=>$data) {
            ...
            echo '<li class="glide__slide">
                        <div class="container" id="post-slider">
                                <div class="row">
                                        <div class="col-md-7 post-slider-image" onclick="viewImageFunction( &#x22post'.$key.'&#x22)" id="post'.$key.'" style=" background-image: url( &#x22;../cees-dynamicdev/assets/images/' . $url[4] . '&#x22;)">
                                            <div class="overlay">
