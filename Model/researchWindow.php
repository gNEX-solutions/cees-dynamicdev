...
class researchWindow extends dbh{
   ...
   { 
      ...
      $sql="SELECT * FROM blog_posts b WHERE b.status = 1 ORDER BY b.modified_at DESC";
    ...
    { 
       ...
       $sql1="SELECT * FROM blog_posts b WHERE b.idblog_posts = ".$artID." AND b.status = 1 ORDER BY b.modified_at DESC";
